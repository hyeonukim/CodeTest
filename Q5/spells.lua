--this file is under otclient/modules/gamelib/spells.lua
SpelllistSettings = {
    ['Default'] = {
        ...
        spellOrder = {'frigo', 'Animate Dead', 'Annihilation', "Apprentice's Strike", 'Arrow Call', 'Avalanche', 'Berserk',
